...
public class Luchador extends Personaje{
    ...
    public Luchador(String nombre, int vida, int armadura, int resmag, int ataque, int poderhab, int mana, Habilidad[] habilidades, int vidaextra, int armaduraExtra, int resmagExtra, int ataqueExtra){
    ...
    public String toString() {
        return  nombre + " es Luchador,"+" tiene " + vida + " de vida, "+ armadura + " de armadura y "+ resmag+ " de resistencia magica, " +  ataque + " de ataque y " + poderhab + " de poder de habilidad, además de " + mana + " de mana, "+" sus habilidades son: " + Arrays.toString(habilidades);
    }
}
